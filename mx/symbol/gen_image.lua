...
function M.adjust_lighting(data, alpha, name, attr, out, kwargs)
end
...
---@param name string @optional | Name of the resulting symbol.
---@return mx.symbol.Symbol @The result symbol.
function M.crop(data, x, y, width, height, name, attr, out, kwargs)
end
...
---@param name string @optional | Name of the resulting symbol.
---@return mx.symbol.Symbol @The result symbol.
function M.flip_left_right(data, name, attr, out, kwargs)
end
...
---@param name string @optional | Name of the resulting symbol.
---@return mx.symbol.Symbol @The result symbol.
function M.flip_top_bottom(data, name, attr, out, kwargs)
end
...
---@param name string @optional | Name of the resulting symbol.
---@return mx.symbol.Symbol @The result symbol.
function M.normalize(data, mean, std, name, attr, out, kwargs)
end
...
---@param name string @optional | Name of the resulting symbol.
---@return mx.symbol.Symbol @The result symbol.
function M.random_brightness(data, min_factor, max_factor, name, attr, out, kwargs)
end
...
---@param name string @optional | Name of the resulting symbol.
---@return mx.symbol.Symbol @The result symbol.
function M.random_color_jitter(data, brightness, contrast, saturation, hue, name, attr, out, kwargs)
end
...
---@param name string @optional | Name of the resulting symbol.
---@return mx.symbol.Symbol @The result symbol.
function M.random_contrast(data, min_factor, max_factor, name, attr, out, kwargs)
end
...
---@param name string @optional | Name of the resulting symbol.
---@return mx.symbol.Symbol @The result symbol.
function M.random_flip_left_right(data, name, attr, out, kwargs)
end
...
---@param name string @optional | Name of the resulting symbol.
---@return mx.symbol.Symbol @The result symbol.
function M.random_flip_top_bottom(data, name, attr, out, kwargs)
end
...
---@param name string @optional | Name of the resulting symbol.
---@return mx.symbol.Symbol @The result symbol.
function M.random_hue(data, min_factor, max_factor, name, attr, out, kwargs)
end
...
---@param name string @optional | Name of the resulting symbol.
---@return mx.symbol.Symbol @The result symbol.
function M.random_lighting(data, alpha_std, name, attr, out, kwargs)
end
...
---@param name string @optional | Name of the resulting symbol.
---@return mx.symbol.Symbol @The result symbol.
function M.random_saturation(data, min_factor, max_factor, name, attr, out, kwargs)
end
...
---@param name string @optional | Name of the resulting symbol.
---@return mx.symbol.Symbol @The result symbol.
function M.resize(data, size, keep_ratio, interp, name, attr, out, kwargs)
end
...
---@param name string @optional | Name of the resulting symbol.
---@return mx.symbol.Symbol @The result symbol.
function M.to_tensor(data, name, attr, out, kwargs)
end
